    ...
    ->setSection([
        ...
        'fields'     => [
            [
                'id'         => 'ldp_hero_tagline',
                'type'       => 'textarea',
                'label'      => 'Tagline (dùng || để xuống dòng)',
                'attributes' => [
                    'name'    => 'ldp_hero_tagline',
                    'value'   => null,
                    'options' => [
                        'class'       => 'form-control',
                        'rows'        => 3,
                        'placeholder' => 'Kỷ nguyên mới - Công nghệ mới||Điều đặc biệt đang dần lộ diện',
                    ],
                ],
            ],
            [
                'id'         => 'ldp_countdown_date',
                'type'       => 'text',
                'label'      => 'Ngày đếm ngược (YYYY-MM-DD HH:MM:SS)',
                'attributes' => [
                    'name'    => 'ldp_countdown_date',
                    'value'   => null,
                    'options' => [
                        'class'       => 'form-control',
                        'placeholder' => '2026-06-06 00:00:00',
                    ],
                ],
            ],
            [
                'id'         => 'ldp_countdown_label',
                'type'       => 'text',
                'label'      => 'Nhãn đếm ngược (VD: 06.06.2026)',
                'attributes' => [
                    'name'    => 'ldp_countdown_label',
                    'value'   => null,
                    'options' => [
                        'class'       => 'form-control',
            ...
            [
                'id'         => 'ldp_s1_bg',
                'type'       => 'mediaImage',
                'label'      => 'Background Desktop (Section 1)',
                'attributes' => [
                    'name'  => 'ldp_s1_bg',
                    'value' => null,
                ],
            ...
            [
                'id'         => 'ldp_s1_bg_mb',
                'type'       => 'mediaImage',
                'label'      => 'Background Mobile (Section 1)',
                'attributes' => [
                    'name'  => 'ldp_s1_bg_mb',
                    'value' => null,
                ],

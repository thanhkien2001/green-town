...
mix
    ...
    .js(source + '/assets/js/landing-page.js', dist + '/js')
    .sass(source + '/assets/sass/landing-page.scss', dist + '/css')
    .copyDirectory(source + '/assets/fonts', dist + '/fonts')
    .copyDirectory(source + '/assets/images', dist + '/images')

if (mix.inProduction()) {
    mix.copy(dist + '/css/style.css', source + '/public/css')
        .copy(dist + '/css/landing-page.css', source + '/public/css')
        .copy(dist + '/js/ripple.js', source + '/public/js')
        .copy(dist + '/js/icons-field.js', source + '/public/js')
        .copy(dist + '/js/landing-page.js', source + '/public/js')
}

...
/*!**********************************************************!*\
  !*** ./platform/themes/ripple/assets/js/landing-page.js ***!
  \**********************************************************/
/* =============================================================
...
(function () {
  ...
  function initProvinceSelect() {
    ...
    var fallbackProvinces = ["Hà Nội", "Cao Bằng", "Tuyên Quang", "Điện Biên", "Lai Châu", "Sơn La", "Lào Cai", "Thái Nguyên", "Lạng Sơn", "Quảng Ninh", "Bắc Ninh", "Phú Thọ", "Hải Phòng", "Hưng Yên", "Ninh Bình", "Thanh Hóa", "Nghệ An", "Hà Tĩnh", "Quảng Trị", "Thừa Thiên Huế", "Đà Nẵng", "Quảng Ngãi", "Gia Lai", "Khánh Hòa", "Đắk Lắk", "Lâm Đồng", "Đồng Nai", "TP. Hồ Chí Minh", "Tây Ninh", "Đồng Tháp", "Vĩnh Long", "An Giang", "Cần Thơ", "Cà Mau"];

    // Thứ tự vàng ưu tiên hiển thị của 6 Thành phố trực thuộc Trung ương
    var hotProvincesOrder = ["Hà Nội", "TP. Hồ Chí Minh", "Đà Nẵng", "Hải Phòng", "Cần Thơ", "Thừa Thiên Huế"];
    ...
    var renderOptions = function renderOptions(provinces) {
      ...
      var createLiOption = function createLiOption(cleanedName) {
